    ...
    >
       ...
       <div className='flex flex-col items-center justify-center w-full mt-28'>
        ...
        <div className='flex items-center justify-center w-1/2'>
            <Text content={`Your account has been temporarily suspended. 
                            Our administrative team is reviewing your account. 
                            You will not be able to access the platform until the review is complete. 
